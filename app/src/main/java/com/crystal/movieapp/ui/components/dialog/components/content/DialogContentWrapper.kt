package com.crystal.movieapp.ui.components.dialog.components.content
...
fun ColumnScope.NormalTextContent(text: DialogText.Default) {
    Text(
        ...
        modifier = Modifier
            ...
            .align(Alignment.CenterHorizontally), // Alignment는 column에서만 쓸 수 있어서 ColumnScope를 명시해줘야 함
