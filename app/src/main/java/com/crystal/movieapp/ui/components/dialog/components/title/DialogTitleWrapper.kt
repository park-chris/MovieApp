package com.crystal.movieapp.ui.components.dialog.components.title
...
import com.crystal.movieapp.ui.theme.h5Title
...
fun DialogPreview() {
    MovieAppTheme() {
        DefaultDialogTitle(title = DialogTitle.Default("sdsdff"))
    }
}